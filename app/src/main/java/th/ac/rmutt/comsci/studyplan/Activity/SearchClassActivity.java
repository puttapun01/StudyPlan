...
public class SearchClassActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private FloatingSearchView searchViewClassroom;
    ...
    private void startSearchSetting() {
        searchViewClassroom.setOnHomeActionClickListener(new FloatingSearchView.OnHomeActionClickListener() {
            @Override
        ...
        searchViewClassroom.setOnBindSuggestionCallback(new SearchSuggestionsAdapter.OnBindSuggestionCallback() {
            @Override
    ...
    private void startDialogAddClassroom() {
        ...
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(SearchClassActivity.this);
        ...
        mImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(SearchClassActivity.this, "เพิ่มรูป",Toast.LENGTH_SHORT).show();
                changProfilePicture();
            }
        });
            ...
            public void onClick(View v) {
                mDatabaseUser.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(switchPassword.isChecked() && !id.isEmpty() && !name.isEmpty() && !sec.isEmpty() && !password.isEmpty()){
                            ...
                            addClassroom.child("username").setValue(dataSnapshot.child("name").getValue()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    dialog.dismiss();
                                    mProgress.dismiss();
                                    Toast.makeText(SearchClassActivity.this, "เพิ่มห้องเรียนใหม่แล้ว", Toast.LENGTH_SHORT).show();
                        ...
                        if(switchPassword.isChecked() && id.isEmpty() && name.isEmpty() && sec.isEmpty() && password.isEmpty()){
                            Toast.makeText(SearchClassActivity.this,"#1 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(switchPassword.isChecked() && !id.isEmpty() && name.isEmpty() && sec.isEmpty() && password.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#2 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(switchPassword.isChecked() && !id.isEmpty() && !name.isEmpty() && sec.isEmpty() && password.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#3 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(switchPassword.isChecked() && !id.isEmpty() && !name.isEmpty() && !sec.isEmpty() && password.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#4 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(switchPassword.isChecked() && id.isEmpty() && !name.isEmpty() && sec.isEmpty() && password.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#5 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(switchPassword.isChecked() && id.isEmpty() && name.isEmpty() && !sec.isEmpty() && password.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#6 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(switchPassword.isChecked() && id.isEmpty() && name.isEmpty() && sec.isEmpty() && !password.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#7 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(switchPassword.isChecked() && id.isEmpty() && name.isEmpty() && !sec.isEmpty() && !password.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#8 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(switchPassword.isChecked() && id.isEmpty() && !name.isEmpty() && !sec.isEmpty() && password.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#9 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(switchPassword.isChecked() && id.isEmpty() && !name.isEmpty() && sec.isEmpty() && !password.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#10 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(switchPassword.isChecked() && id.isEmpty() && !name.isEmpty() && !sec.isEmpty() && !password.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#11 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(switchPassword.isChecked() && !id.isEmpty() && name.isEmpty() && sec.isEmpty() && !password.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#12 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(switchPassword.isChecked() && !id.isEmpty() && name.isEmpty() && !sec.isEmpty() && password.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#13 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        /*----- Switch OFF -----*/

                        if(!switchPassword.isChecked() && id.isEmpty() && name.isEmpty() && sec.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#14 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(!switchPassword.isChecked() && !id.isEmpty() && name.isEmpty() && sec.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#15 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(!switchPassword.isChecked() && !id.isEmpty() && !name.isEmpty() && sec.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#16 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(!switchPassword.isChecked() && id.isEmpty() && name.isEmpty() && !sec.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#17 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(!switchPassword.isChecked() && id.isEmpty() && !name.isEmpty() && sec.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#18 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(!switchPassword.isChecked() && id.isEmpty() && !name.isEmpty() && !sec.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#19 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }

                        if(!switchPassword.isChecked() && !id.isEmpty() && name.isEmpty() && !sec.isEmpty()){
                            Toast.makeText(SearchClassActivity.this, "#20 "  + "กรุณาใส่ข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                        }
            ...
            protected void populateViewHolder(final ClassroomViewHolder viewHolder, final Classroom model, final int position) {
                ...
                viewHolder.mView.findViewById(R.id.btnRegClassroom).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (lock.equals("yes")) {
                            Toast.makeText(SearchClassActivity.this, "มีรหัสผ่าน", Toast.LENGTH_SHORT).show();

                            final AlertDialog.Builder mBuilder = new AlertDialog.Builder(SearchClassActivity.this);
                            ...
                            btnCheckPassword.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if (!password.equals(p)) {
                                        Toast.makeText(SearchClassActivity.this, "รหัสผ่าน ผิด", Toast.LENGTH_SHORT).show();
                                    }
                                    if (password.equals(p)) {
                                        Toast.makeText(SearchClassActivity.this, "รหัสผ่าน ถูกต้อง", Toast.LENGTH_SHORT).show();
                                        ...
                                        dialog.dismiss();
                                        finish();
                                        startActivity(new Intent(SearchClassActivity.this, ProfileActivity.class));
                                    }
                                }
                            });
                        }
                        ...
                        if (lock.equals("no")) {
                            Toast.makeText(SearchClassActivity.this, "ไม่มีรหัสผ่าน", Toast.LENGTH_SHORT).show();
                    ...
                    public void onClick(View v) {
                        ...
                        mDatabase.child(Classroom_key).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                Picasso.with(SearchClassActivity.this).load(classroom_image).into(mImage);
    ...
    private void initView() {
        ...
        searchViewClassroom = (FloatingSearchView) findViewById(R.id.searchViewClassroom);
